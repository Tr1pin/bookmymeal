...
const pedidoSchema = z.object({
    usuario_id: z.string().uuid({ message: 'usuario_id debe ser un UUID válido' }).nullable().optional(),
    ...
    direccion_calle: z.string().max(255).nullable().optional(),
    direccion_ciudad: z.string().max(100).nullable().optional(),
    direccion_codigo_postal: z.string().max(10).nullable().optional(),
    direccion_telefono: z.string().max(15).nullable().optional(),
    ...
    // Si es domicilio, los campos de dirección son obligatorios y no pueden ser null
